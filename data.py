...
def character_info_list(name):
    if name.lower() == "list":
        charlist = ["<:albedo:910108780442812457> **[5★]** Albedo",
                    ...
                    "<:itto:920380021829435482> **[5★]** Arataki Itto",
                    ...
                    "<:gorou:920380111474262066> **[4★]** Gorou",
        ...
        return ganyu
    elif name.lower() == "hu tao" or name.lower() == "hutao":
        ...
        return qiqi
    elif name.lower() == "raiden shogun" or name.lower() == "raiden" or name.lower() == "shogun" or name.lower() == "ei":
        ...
        return ven
    elif name.lower() == "xiangling" or name.lower() == "mao" or name.lower() == "chef":
        ...
        return tra
    elif name.lower() == "itto" or name.lower() == "arataki itto" or name.lower() == "arataki":
        itto = {'name': 'Arataki Itto', 'his1':'Arataki Itto (ภาษาญี่ปุ่น: 荒あら瀧たき一いっ斗と Arataki Itto) เป็นตัวละครชายธาตุหินที่เล่นได้ในเกม Genshin Impact\n\n \
                Arataki มีสายเลือดยักษ์โอนิ อีกทั้งยังเป็นหัวหน้าใหญ่ประจำแก๊ง Arataki',
                'stat':['12,858', '227', '959', '19.2%' , '(CRIT RATE)'],
                'ascen':'**[✦-----]**:20,000 Mora, Prithiva Topaz Sliver x1, Onikabuto x3, Slime Condensate x3\n \
                        **[✦✦----]**:40,000 Mora, Prithiva Topaz Fragment x3, Riftborn Regalia x2, Onikabuto x10, Slime Condensate x15\n \
                        **[✦✦✦---]**:60,000 Mora, Prithiva Topaz Fragment x6, Riftborn Regalia x4, Onikabuto x20, Slime Secretions x12\n \
                        **[✦✦✦✦--]**:80,000 Mora, Prithiva Topaz Chunk x3, Riftborn Regalia x8, Onikabuto x30, Slime Secretions x18\n \
                        **[✦✦✦✦✦-]**:100,000 Mora, Prithiva Topaz Chunk x6, Riftborn Regalia x12, Onikabuto x45, Slime Concentrate x12\n \
                        **[✦✦✦✦✦✦]**:120,000 Mora, Prithiva Topaz Gemstone x6, Riftborn Regalia x20, Onikabuto x60, Slime Concentrate x24',
                        'thum':'https://static.wikia.nocookie.net/gensin-impact/images/7/79/Character_Arataki_Itto_Thumb.png/revision/latest/scale-to-width-down/50?cb=20211214102037',
                        'star':'[★★★★★]', 'detail':['<:claymores:909806179205664810> ดาบใหญ่', 'Inazuma', '1 มิถุนายน', '<:geo:909771888413257769> หิน']}
        return itto
    elif name.lower() == "gorou":
        gorou = {'name': 'Gorou', 'his1':'Gorou (ภาษาไทย: โกโร่; ภาษาญี่ปุ่น: ゴロー Goroo) เป็นตัวละครชายธาตุหินที่เล่นได้ในเกม Genshin Impact\n\n \
                พลเอกของกองทหารแห่งเกาะ Watatsumi ผู้ได้รับความไว้วางใจจากผู้ใต้บังคับบัญชาเป็นอย่างสูง',
                'stat':['9,570', '183', '648', '24%', '(Geo DMG Bonus)'],
                'ascen':'**[✦-----]**:20,000 Mora, Prithiva Topaz Sliver x1, Sango Pearl x3, Spectral Husk x3\n \
                        **[✦✦----]**:40,000 Mora, Prithiva Topaz Fragment x3, Riftborn Regalia x2, Sango Pearl x10, Spectral Husk x15\n \
                        **[✦✦✦---]**:60,000 Mora, Prithiva Topaz Fragment x6, Riftborn Regalia x4, Sango Pearl x20, Spectral Heart x12\n \
                        **[✦✦✦✦--]**:80,000 Mora, Prithiva Topaz Chunk x3, Riftborn Regalia x8, Sango Pearl x30, Spectral Heart x18\n \
                        **[✦✦✦✦✦-]**:100,000 Mora, Prithiva Topaz Chunk x6, Riftborn Regalia x12, Sango Pearl x45, Spectral Nucleus x12\n \
                        **[✦✦✦✦✦✦]**:120,000 Mora, Prithiva Topaz Gemstone x6, Riftborn Regalia x20, Sango Pearl x60, Spectral Nucleus x24',
                        'thum':'https://static.wikia.nocookie.net/gensin-impact/images/5/56/Character_Gorou_Thumb.png/revision/latest/scale-to-width-down/50?cb=20211126224331',
                        'star':'[★★★★]', 'detail':['<:bows:909806179427942400> ธนู', 'Inazuma', '18 พฤษภาคม', '<:geo:909771888413257769> หิน']}
        return gorou
